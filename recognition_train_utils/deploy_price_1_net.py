...
NET_PATH = environ["BEORGDATAGEN"] + "/price_1_net"
NET_PROTO_TRAIN = NET_PATH + "/price_1_train.prototxt"
NET_PROTO_TEST = NET_PATH + "/price_1_test.prototxt"
NET_PROTO_DEPLOY = NET_PATH + "/price_1_net.prototxt"
SOLVER_PROTO = NET_PATH + "/price_1_net_solver.prototxt"
TRAIN_LMDB_PATH = environ["BEORGDATAGEN"] + "/CData_full/price_1_lmdb_train"
TEST_LMDB_PATH = environ["BEORGDATAGEN"] + "/CData_full/price_1_lmdb_test"
...
def define_solver_params():
    ...
    params.snapshot_prefix = "price_1"
    return params
...
if not path.exists(TRAIN_LMDB_PATH):
    ...
    system("python3 ../marking_tools/generate_lmdb.py %s"%("price_1"))
...
if(path.exists(NET_PATH)):
    ...
    shutil.copyfile("price_1_net/classify.py", NET_PATH + "/classify.py")
    shutil.copyfile("price_1_net/train.py", NET_PATH + "/train.py")
    shutil.copyfile(environ["BEORGDATAGEN"] + "/CData_full/price_1_lmdb_dict.json",
                    NET_PATH + "/price_1_lmdb_dict.json")
